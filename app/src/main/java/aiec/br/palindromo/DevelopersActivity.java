...
public class DevelopersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.setTitle(getString(R.string.equipe_titulo));
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView lblSection = (TextView) rootView.findViewById(R.id.section_label);
            ImageView imgView = (ImageView) rootView.findViewById(R.id.imgDeveloperPhoto);
            TextView txtProfile = (TextView) rootView.findViewById(R.id.lblDeveloperDescription);
            ...
            lblSection.setText(getString(descId));
            imgView.setImageResource(photoId);
            imgView.setContentDescription(getString(descId));
            txtProfile.setText(getString(profileId));
